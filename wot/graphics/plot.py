...
def plot_tetrahedron(fate_ds, name1, name2, name3, day, 
    ...
    days = pd.unique(fate_ds.obs.day)
    day = days[np.argmin(abs(days - day))]
    
    fate1 = fate_ds[:,name1][fate_ds.obs['day']==day].X.flatten()
    fate2 = fate_ds[:,name2][fate_ds.obs['day']==day].X.flatten()
    fate3 = fate_ds[:,name3][fate_ds.obs['day']==day].X.flatten()
    ...
    # Plot the cells
    ax.scatter(xs=x, ys=y, zs=z, zdir='z', s=4, c=None, depthshade=True)
